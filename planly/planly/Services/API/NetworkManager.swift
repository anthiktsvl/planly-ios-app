...
/*  High-level API wrapper used by ViewModels. This layer keeps networking details out of the UI by exposing intent-based methods like signIn(), getTasks(), createMeeting(), etc.
    Under the hood, NetworkManager does the actual request building/decoding. APIService focuses on:
            - constructing request bodies (DTOs)
            - choosing endpoints + HTTP methods
            - simple formatting (dates/times) that the backend expects
*/
